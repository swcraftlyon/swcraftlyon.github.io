...
- \n sans refacto des séparateurs n'était pas une bonne idée. On a rollback pour nettoyer avant de faire ça.
...
- Pourquoi faites-vous ces évènements ? Pour s'entrainer, progresser, partager, aider. 
